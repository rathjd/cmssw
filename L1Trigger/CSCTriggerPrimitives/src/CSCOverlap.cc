...
CSCOverlap::CSCOverlap(unsigned endcap, unsigned station, unsigned ring, bool isganged, const edm::ParameterSet& luts)
...
bool CSCOverlap::doesWiregroupCrossHalfStrip(int wiregroup, int halfstrip) const {
